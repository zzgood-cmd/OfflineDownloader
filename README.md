...
```bash
sudo bash offline-downloader-onekey-install-v1.6.2.sh
```
...
```bash
sudo WEB_PORT=8080 BT_PORT=6881 bash offline-downloader-onekey-install-v1.6.2.sh
```
...
```bash
tar -xzf offline-downloader-docker-v1.6.2.tar.gz
...
```text
offline-downloader-docker-v1.6.2.tar.gz
```
