...
```bash
sudo bash offline-downloader-onekey-install-v1.5.9.sh
```
...
```bash
sudo WEB_PORT=8080 BT_PORT=6881 bash offline-downloader-onekey-install-v1.5.9.sh
```
...
```bash
tar -xzf offline-downloader-docker-v1.5.9.tar.gz
...
```text
offline-downloader-docker-v1.5.9.tar.gz
```
